...
I create getters and setters for each property of the TestCase class. A private prop is used to store the actual value and a public Prop is used to expose the value.
