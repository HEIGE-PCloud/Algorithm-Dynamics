...
The original problem, `mark the students' answer by a computer', is a difficult one for a computer. But I transform the question into `compare the output of the students' code solution with test cases', which makes the problem solvable by a computational method. The computer is good at `executing the code' and `comparing two strings'. This solution solves the `marking' question from another angle and makes the question suited to a computational solution.
...
For teachers, the software requires them to enter questions and test cases. Need to provide them with a question editor containing input boxes.

For the students, the software requires them to enter their code solutions. Need to provide them with a code editor.
...
\begin{enumerate}
    \item Do you find your students tend to lose marks in the code writting questions in A Level exams?
    \item Do you find marking the coding question takes a lot of time and effort?
    \item Do you find it is more difficult to monitor students' learning level on algorithm than hardware
    \item Do you know the learning
    \item If yes, do you think such platform can deliver a better experience?
    \item Do you think a similar solution can help improve teaching?
...
\begin{enumerate}
    \item Do you find coding questions difficult?
    \item Do you find practicing those questions difficult?
    \item Have you tried any online coding platform?
    \item If yes, do you think such platform can deliver a better experience?
    \item Do you think such a solution can improve your learning?
    \item Do you have anything else to add?
\end{enumerate}
...
Diff editor to show difference.

Database. Search problem. Find submission.
