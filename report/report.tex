...
\begin{minted}[linenos,tabsize=4,breaklines,breakanywhere]{text}
...
\begin{minted}[linenos,tabsize=4,breaklines,breakanywhere]{json}
{
    "Theme": "Light",
...
\begin{minted}[linenos,tabsize=4,breaklines,breakanywhere]{sql}
CREATE TABLE User
(
...
\begin{minted}[linenos,tabsize=4,breaklines,breakanywhere]{markdown}
# Markdown Tests
...
\begin{minted}[linenos,tabsize=4,breaklines,breakanywhere]{cpp}
#include <iostream>
using namespace std;
int main()
{
...
\begin{minted}[linenos,tabsize=4,breaklines,breakanywhere]{xml}
<Application
...
\begin{minted}[linenos,tabsize=4,breaklines,breakanywhere]{csharp}
...
\begin{minted}[linenos,tabsize=4,breaklines,breakanywhere]{html}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
\begin{minted}[linenos,tabsize=4,breaklines,breakanywhere]{javascript}
