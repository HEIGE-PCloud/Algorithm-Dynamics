...
It has a one-to-one relationship with a Submission, so a \mintinline{text}{SubmissionId} field is used to record this relationship. It may have a many-to-one relationship with a AssignmentSubmissionResult, so a AssignmentSubmissionResultUid field is used to record this relationship. 
