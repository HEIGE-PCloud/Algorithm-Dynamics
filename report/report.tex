...
The \mintinline{text}{User} object is used to manage the current user identity. Its data will be recorded attached to \mintinline{text}{Submission}, \mintinline{text}{Assignment} and \mintinline{text}{AssignmentSubmission}.
...
\begin{tabulary}{\textwidth}{|l|l|L|}
    ...
    \hline
    \mintinline{text}{Assignment} & \mintinline{text}{Assignment} & The \mintinline{text}{Assignment} corresponding to this \mintinline{text}{AssignmentSubmission} is recorded, so the \mintinline{text}{Judger} knows how to judge it. \\
    \hline
...
\begin{tabulary}{\textwidth}{|l|l|L|}
    ...
    Variable & Data type & Justification \\
    \hline
    \mintinline{text}{Id} & \mintinline{text}{int} & todo \\
    \hline
    \mintinline{text}{TestCase} & \mintinline{text}{TestCase} & todo \\
    \hline
    \mintinline{text}{StandardOutput} & \mintinline{text}{string} & todo \\
    \hline
    \mintinline{text}{StandardError} & \mintinline{text}{string} & todo \\
    \hline
    \mintinline{text}{ExitCode} & \mintinline{text}{int} & todo \\
    \hline
    \mintinline{text}{CPUTime} & \mintinline{text}{int} & todo \\
    \hline
    \mintinline{text}{MemoryUsage} & \mintinline{text}{int} & todo \\
    \mintinline{text}{ResultCode} & \mintinline{text}{enum ResultCode} & todo \\
    \hline
\end{tabulary}
...
\begin{tabulary}{\textwidth}{|l|l|L|}
    ...
    \hline
    \mintinline{text}{Submission} & \mintinline{text}{Submission} & todo \\
    \hline
    \mintinline{text}{TestCaseResults} & \mintinline{text}{List<TestCaseResult>} & todo\\
    \hline
 \end{tabulary}
...
\begin{tabulary}{\textwidth}{|l|l|L|}
    ...
    Variable & Data type & Justification \\
    \hline
    \mintinline{text}{Uid} & \mintinline{text}{Guid} & ToDo \\
    \hline
    \mintinline{text}{AssignmentSubmission} & \mintinline{text}{AssignmentSubmission} & todo \\
    \hline
    \mintinline{text}{SubmisionResults} & \mintinline{text}{List<SubmissionResult>} & todo \\
    \hline
\end{tabulary}
...
\begin{tabulary}{\textwidth}{|L|L|L|L|L|}
    ...
    \hline
    <GUID> & Lucy & Wilson & lucyw@test.com & 0 \\
    \hline
\end{tabulary}
...
\begin{tabulary}{\textwidth}{|L|L|L|L|L|L|L|}
    ...
    \hline
    1 & Problem1 & Description1 & 0 & 0 & 1000 & 1000 \\
    \hline
\end{tabulary}
