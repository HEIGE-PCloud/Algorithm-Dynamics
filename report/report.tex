...
The ProblemList table has an auto-increment integer \mintinline{text}{Id} as its primary key. The description is allowed to be empty for easy sharing.
...
The Assignment table will have \mintinline{text}{Uid} as its primary key. It will have a one-to-many relationship with \mintinline{text}{User}, so a \mintinline{text}{UserUid} field is used to record this relationship.
...
\begin{tabulary}{\textwidth}{|L|L|L|L|}
    \hline
    Id & TestCaseId & StandardOutput & StandardError \\
    \hline
    1 & 1 & ``Standard output'' & ``Standard error'' \\
    \hline
\end{tabulary}
...
\begin{tabulary}{\textwidth}{|L|L|L|L|L|}
    \hline
    ExitCode & CPUTime & MemoryUsage & ResultCode & SubmissionId\\
    \hline
    0 & 1000 & 1000 & 0 & 1 \\
    \hline
\end{tabulary}
