...
A \mintinline{text}{Tag} is a label used to categorize a \mintinline{text}{Problem} or a \mintinline{text}{ProblemList}.
...
\begin{tabulary}{\textwidth}{|l|l|L|}
    ...
    \hline
    \mintinline{text}{Output} & \mintinline{text}{string} & The expected output of the input. The \mintinline{text}{Judger} will compare user's output with the \mintinline{text}{Output} to judge whether user's code is correct. \\
    \hline
...
\begin{tabulary}{\textwidth}{|l|l|L|}
    ...
    Variable & Data type & Justification \\
    \hline
    \mintinline{text}{Id} & \mintinline{text}{int} & The \mintinline{text}{Id} is the local unique identifier for a \mintinline{text}{Problem}, it comes in handy when I need to store a \mintinline{text}{Problem} into the database. \\
    \hline
...
A \mintinline{text}{Submission} is created when the user submits a piece of code solution to a \mintinline{text}{Problem}. The \mintinline{text}{Submission} will contain all the information including the time, the source code, the programming language selected and the corresponding \mintinline{text}{Problem}.
...
\begin{tabulary}{\textwidth}{|l|l|L|}
    ...
    \hline
    \mintinline{text}{Tags} & \mintinline{text}{List<Tag>} & \mintinline{text}{Tags} stores a list of \mintinline{text}{Tag} for the \mintinline{text}{ProblemList}. Users can add new \mintinline{text}{Tag} to a \mintinline{text}{ProblemList}, which allows easier searching. \\
    \hline
\end{tabulary}
...
\begin{tabulary}{\textwidth}{|l|l|L|}
    ...
    \hline
    \mintinline{text}{Name} & \mintinline{text}{string} & The \mintinline{text}{Name} is a \mintinline{text}{string} to store the name of the \mintinline{text}{Assignment}. \\
    \hline
    ...
    \hline
    \mintinline{text}{Description} & \mintinline{text}{string} & The description is a string to store the description of the \mintinline{text}{Assignment}. \\
    \hline
...
\subsection{Milestore 1: Create the main interface}
...
\subsection{Milestore 2: Handle settings}
...
\subsection{Milestore 3: Implement the Judger}
...
\subsection{Milestore 4: Implement data structures}
...
\subsection{Milestore 5: Create the database}
...
\subsection{Milestore 6: Handle data import/export}
...
\subsection{Milestore 7: Handle API calls}
