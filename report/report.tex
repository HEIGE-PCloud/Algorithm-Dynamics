...
Timofei thinks there can be more interesting statistics, such as favourite variable names, and total time spend in the software.
...
Timofei likes the idea of being able to switch between a light theme and a dark theme. He thinks it will be better if users are allowed to create their own custom theme. He also suggests that allowing the user to change the font size manually may help a lot.
