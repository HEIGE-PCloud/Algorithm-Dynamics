...
\begin{tabulary}{\textwidth}{|l|l|L|}
      ...
      \hline
      \mintinline{text}{Tags} & \mintinline{text}{List<Tag>} & \mintinline{text}{Tags} stores a list of \mintinline{text}{Tag} for the problem list. Users can add new \mintinline{text}{Tag} to a \mintinline{text}{ProblemList}, which allows easier searching. \\
      \hline
\end{tabulary}
