...
\begin{enumerate}
    ...
    \item Have you ever considered using them for teaching and practicing?
...
\begin{enumerate}
    ...
    \item Do you find yourself lacking efficient practicing in algorithm designing and programming?
          ...
          Absolutely. Although I code a lot in my spare time, normal projects are quite different from the exam questions. There are not many past papers and exam-style questions for practicing, so I usually don't feel confident of those questions.
...
\begin{tabulary}{\linewidth}{|L|L|}
      ...
      \hline
      Users can create submissions for assignments and export them into a file or upload it to Microsoft Teams for Education. & This allows the students to complete and hand in assignments easily.\\
      \hline
      ...
      \hline
      Users can customize the software. & This allows users to work in their favorite environment and makes the solution suitable to users with different backgrounds.\\
      \hline
\end{tabulary}
